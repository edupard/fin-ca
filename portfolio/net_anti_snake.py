...
class NetAntiSnake(object):
    def __init__(self):
        ...
        with tf.name_scope('loss'):
            ...
            short_feature = tf.gather(x, [0], name='short_feature')

            sell_prob = tf.nn.softmax(short_feature, name='sell_prob')
            self.weights = weights = tf.reshape(sell_prob, [-1])
